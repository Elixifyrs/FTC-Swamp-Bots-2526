...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 1463.4129537914819; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1425.421857835723; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = 1479.2519762207564; // x position of the perpendicular encoder (in tick units)
    }
